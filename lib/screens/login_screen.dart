                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        ...
                        style: TextStyle(color: Color(0xFF3DE98C), fontSize: 15),
                      ),
                    ),
                  ],
                ),
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: SelectableText(
                  privateKey,
                  style: const TextStyle(color: Color(0xFF3DE98C), fontSize: 14, fontFamily: 'monospace'),
                ),
              ),
      ...
      if (!kIsWeb) {
        ...
        try {
          ...
          if (mnemonic != null) {
            ...
            debugPrint('?? Se você tinha saldo, use Login Avançado para vincular seed!');
